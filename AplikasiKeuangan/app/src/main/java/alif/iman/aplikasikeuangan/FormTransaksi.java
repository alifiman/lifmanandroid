...
public class FormTransaksi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnJenis = (Spinner) findViewById(R.id.inp_jenis);
        ...
        edtNama = (EditText) findViewById(R.id.inp_nama);
        edtJumlah = (EditText) findViewById(R.id.inp_jumlah);
        edtKeterangan = (EditText) findViewById(R.id.inp_keterangan);
    }
